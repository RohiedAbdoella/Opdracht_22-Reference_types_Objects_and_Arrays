...
colors.push('groen', 'blauw', 'rood', 'geel', 5, {greeting: "hi ik ben een object"})
...
//expected output: American Bobtail
console.log("Naam kat 3:", catBreeds[2].name);

//expected output: 5
console.log("Energy levels kat 1:", catBreeds[0].energy_level);

//expected output: Eerste temperament van de temperamenten van de 2e kat
console.log("Eerste temperament kat 2:", catBreeds[1].temperament[0]);

//expected output: Laatste temperament van de temperamenten van de 3e kat
console.log("Laatste temperament kat 3:", catBreeds[2].catBreeds.temperament[-1]);

*/

//expected output: Favoriete voedsel van 3e kat: meaty things
console.log("Favo voedsel kat 3:", catBreed[2].food.favorite_food);
